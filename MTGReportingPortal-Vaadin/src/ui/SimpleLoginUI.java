...
import pages.login.SimpleLoginView;
import pages.login.main.SimpleLoginMainView;

public class SimpleLoginUI extends UI {

	private static final long serialVersionUID = 5854117752866846549L;
    ...
    protected void init(VaadinRequest request) {
        ...
        getNavigator().addViewChangeListener(new ViewChangeListener() {
			...
			private static final long serialVersionUID = 2951710660794469194L;
